  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex justify-between items-start">
        ...
        <button className="flex items-center gap-2 bg-red-700 text-white px-5 py-3 rounded-xl shadow hover:bg-red-600 transition">
          <Plus size={18} />
          Add Location
        </button>
      </div>
...
<div className="w-full overflow-x-auto">
  <table className="w-full min-w-full table-auto text-sm border border-gray-700">
    
    {/* ===== TABLE HEADER ===== */}
    <thead className="bg-slate-50 text-gray-600">
      <tr>
        <th className="p-4 border border-gray-200 text-left font-medium">
          Country Code
        </th>
        <th className="p-4 border border-gray-200 text-left font-medium">
          Country
    ...
    <tbody>
      {countries.map((country, index) => (
        <tr key={index} className="hover:bg-slate-50 transition">
          ...
          <td className="p-4 border border-gray-200 font-medium text-slate-700">
            {country.code}
          </td>

          <td className="p-4 border border-gray-200 text-slate-700">
            {country.name}
          </td>
